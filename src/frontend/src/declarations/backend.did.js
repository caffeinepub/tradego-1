...
export const idlService = IDL.Service({
  ...
  'getAllPositions' : IDL.Func(
      [IDL.Text],
      [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Vec(PositionSummary)))],
      [],
    ),
  ...
  'getSessionFull' : IDL.Func(
      [IDL.Text],
      [IDL.Opt(IDL.Tuple(User, IDL.Bool))],
      ['query'],
    ),
...
export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'getAppSettings' : IDL.Func([], [AppSettings], ['query']),
    'getAvailableBalance' : IDL.Func([], [IDL.Float64], ['query']),
    'getAvailableBalanceByToken' : IDL.Func(
        [IDL.Text],
        [IDL.Float64],
        ['query'],
      ),
    ...
    'getOrders' : IDL.Func([IDL.Text], [IDL.Vec(OrderV2)], ['query']),
    'getPaymentSettings' : IDL.Func(
        [],
        [IDL.Opt(PaymentSettingsV2)],
        ['query'],
      ),
    'getPortfolioSummary' : IDL.Func([IDL.Text], [PortfolioSummary], ['query']),
    'getProfileByToken' : IDL.Func([IDL.Text], [User], ['query']),
